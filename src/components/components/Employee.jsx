...
function Employee()
{
  ...
  const [dob,setDob]=useState("");
     ...
     async function save(event)
    {
        ...
        try
        {
         await axios.post("http://localhost:8088/api/v1/employee/save",
        {
  ...
  return (
    <div>
      <Navbar>
          <Nav>
            <Button style={{"color":"blue"}}><Link to="/Dashboard"  className="ln">Home</Link></Button>
          </Nav>
        </Navbar>
      <html>
        <head>
      ...
      <form className="bu" class="w3-text-blue w3-light-grey w3-margin" style={{padding:"40px"}}>
          ...
          <div class="w3-row w3-section">
            <div class="w3-rest">
              ...
              <input class="w3-border" name="email" type="text" placeholder='Email' value={email}
                onChange={(event) =>
                  {
          ...
          <div class="w3-row w3-section">
            <div class="w3-rest">
              <i class="xxlarge fa fa-calendar" style={{width:"20px"}}></i>
              <input class="w3-border" name="dob" type="date" placeholder='Date of joining' value={dob}
                onChange={(event) =>
                  {
